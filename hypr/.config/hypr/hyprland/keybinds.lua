...
hl.bind("SUPER + SUPER_L", hl.dsp.exec_cmd("pkill fuzzel || fuzzel"), { description = "Shell: Toggle search (Fuzzel)" })
...
hl.bind("SUPER + Backslash", hl.dsp.global("quickshell:cheatsheetToggle"), { description = "Shell: Toggle cheatsheet" })
...
hl.bind("CTRL + ALT + Delete", hl.dsp.exec_cmd("pkill wlogout || wlogout -p layer-shell"), { description = "Session: Toggle session menu (wlogout)" })
